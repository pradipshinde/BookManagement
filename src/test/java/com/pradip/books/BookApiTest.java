...
public class BookApiTest extends CommonTest {
    ...
    @BeforeClass
    public static void beforeClassBookApiTest()
    {
        httpServer=new Server().startServer();
    }

    @Before
    public void beforeBookApiTest()
    {
    ...
    public void v1ItemsShouldReturnStatus200() {
        System.out.println(itemsTarget.request().head().getStatus());
